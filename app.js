...
const bugitV16Faq = {
  ...
  ja: [
    ...
    ['ライセンスが切れるとどうなりますか？','ライセンス期間が終了すると3日間の猚予期間があり、その後は起票とアクティベーションに有効なライセンスが必要になります。ローカルのファイルと設定はそのまま残ります。ライセンスサーバー障害時は別で、キャッシュ確認により最大72時間オフラインで作業できます。 1 年間は購入日に開始します。'],
