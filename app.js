...
const consentI18n = {
  ...
  zh:{title:'Cookie 与衡量',body:'我们使用必要的 Cookie 来运行本网站。在你同意后，我们还会使用 Google 的 Cookie 来衡量广告效果并了解网站使用情况。你可以随时更改你的选择。',privacyLink:'阅读我们的隐私政策',manage:'管理偏好设置',save:'保存偏好设置',reject:'拒绝非必要',accept:'全部接受',essential:'必要',essentialDesc:'网站运行所必需。',always:'始终开启',analytics:'分析',analyticsDesc:'帮助我们了解网站的总体性能和使用情况。',advertising:'广告',advertisingDesc:'帮助我们了解广告是否带来购买。',advMeasureTitle:'广告衡量',advProviderLabel:'提供方',advProvider:'Google',advPurposeLabel:'用途',advPurpose:'广告效果与购买归因',advInfoLabel:'可能处理的信息',advInfo:'广告互动信息、购买金额、币种以及不含个人信息的订单编号',prefsLink:'Cookie 偏好设置'},
