...
const bugitV16Faq = {
  en: [
    ...
    ['Which trackers have built-in tested mapping?', 'All eleven include built-in, tested field mapping and create tickets directly through the tracker’s REST API, using a credential you create in your own account: Jira Cloud, Azure DevOps, GitHub Issues, GitLab Issues, Bugzilla, YouTrack, Linear, Shortcut, ClickUp, Asana and Trello. Filing does not use MCP. Crash tools, test management and other services still connect through your own MCP server. Screenshot and log uploads through BugIt reach eight of the eleven; uploads to GitHub Issues, GitLab Issues and Bugzilla are not supported, and you are told before you try.'],
