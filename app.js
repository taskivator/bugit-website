...
const bugitV16Faq = {
  ...
  ko: [
    ['BugIt이 자동으로 버그를 등록하나요?','아니요. 모든 티켓, 댓글, 첨부, 알림은 먼저 미리보기로 표시됩니다. 되돌릴 수 없는 티켓 등록 전에는 FILE IT을 입력해 승인해야 하며, 채팅 문구만으로는 등록되지 않습니다. 단순히 "예"만으로는 진행되지 않습니다.'],
