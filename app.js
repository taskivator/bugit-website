...
const consentI18n = {
  ...
  body: "نستخدم ملفات تعريف ارتباط أساسية لتشغيل هذا الموقع، إضافة إلى قياس أداء الصفحات من Cloudflare بلا ملفات تعريف ارتباط ودون تتبّعك عبر المواقع. بإذنك، نستخدم أيضًا ملفات تعريف ارتباط من Google لقياس إعلاناتنا وفهم استخدام الموقع. يمكنك تغيير اختيارك في أي وقت.",
