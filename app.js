...
const bugitV16Faq = {
  ...
  es: [
    ...
    ['¿Qué pasa cuando expira mi licencia?','Tras finalizar la licencia anual hay un periodo de gracia de 3 días; después, las funciones de registro de tickets y activación requieren una licencia vigente, mientras que sus archivos y ajustes locales se conservan. Si falla el servidor de licencias, una verificación en caché permite seguir trabajando hasta 72 horas sin conexión. El año comienza en la fecha de compra.'],
  ...
  it: [
    ['BugIt crea bug automaticamente?','No. Ogni ticket, commento, allegato o notifica che contiene la sua segnalazione viene prima mostrato in anteprima. Prima di creare un ticket irreversibile, lo approvi digitando FILE IT; il solo testo della chat non crea mai nulla. Un semplice «sì» non basta. Usi dry run per esercitarsi senza alcuna scrittura. I test di connessione sono la sola eccezione: quando esegue lei stesso notify connect, notify test o notify doctor --live, BugIt invia un messaggio di prova fisso senza anteprima, al canale che indica o, se non ne indica nessuno, a tutti i canali che ha attivato. Questi test non contengono contenuti della segnalazione e anche dry run li blocca.'],
