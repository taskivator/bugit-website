...
- Jira Cloud e Azure DevOps inviano direttamente tramite l'API REST del tracker, con un token API che crei nel tuo account. La configurazione verifica la connessione prima che tu ci faccia affidamento.
