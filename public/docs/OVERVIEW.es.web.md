...
- Registra tickets con una credencial que creas en tu propia cuenta; BugIt comprueba esa credencial en el destino elegido antes de guardar la conexión: Jira Cloud, Azure DevOps, GitHub Issues, GitLab Issues, Bugzilla, YouTrack, Linear, Shortcut, ClickUp, Asana y Trello. Los once, a través de la API de cada gestor.
...
- Lee la [declaración de privacidad](#/docs/privacy).
- Consulta la [guía de seguridad](#/docs/security).
