...
BugIt transforme des notes de test sommaires en rapports de bogues révisés au sein de VS Code. Il fonctionne avec GitHub Copilot Chat, l’extension Claude, d’autres assistants et même un simple terminal. Windows 11 est entièrement pris en charge ; macOS et Linux sont en Preview.
