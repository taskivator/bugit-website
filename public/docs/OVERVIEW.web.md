...
- Windows 11 is fully supported, with VS Code and Python 3.10 through 3.14; macOS and Linux are in Preview. BugIt works with GitHub Copilot Chat, the Claude extension, other assistants, and even a plain terminal.
...
- Review the [security guidance](#/docs/security).