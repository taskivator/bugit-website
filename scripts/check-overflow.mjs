...
const ROUTES = ['#/', '#/docs', '#/docs/getting-started', '#/docs/user-guide', '#/docs/overview', '#/docs/license', '#/docs/privacy', '#/docs/security', '#/docs/refund', '#/docs/faq', '#/support'];
...
function cleanup(code) {
  ...
  removeProfileAfterExit(chrome, udir, 'check-overflow');   // before kill(): see the helper
